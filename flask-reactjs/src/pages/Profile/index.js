      ...
      <div className="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-40">
        <div className='row'>
          <div className="col-sm-3 g-mb-40 g-mb-0--lg">
            ...
            <Link to="/edit-profile" className="btn btn-block u-btn-outline-primary g-rounded-50 g-py-12 g-mb-10">
              <i className="icon-user-follow g-pos-rel g-top-1 g-mr-5"></i> Edit Profile
            </Link>
          </div>
