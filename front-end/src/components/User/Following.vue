    ...
    <div class="card border-0 g-mb-15">
      ...
      >
        <h3 class="h6 mb-0">
          ...
          Following of {{ user.name || user.username }}
          <small
            v-if="followeds"
          >(共 {{ followeds._meta.total_items }} 个, {{ followeds._meta.total_pages }} 页)</small>
        </h3>
...
export default {
  name: 'UserFollowing', // this is the name of the component
  components: {
    Member,
    Pagination
  },
